...
// generic text/password input with an optional label and error message
export default function InputField({
    ...
    // password fields can be toggled to plain text so the user can check
    // what they typed
    ...
    return (
        <div className="flex flex-col space-y-1 w-full">
            ...
            <div className="relative w-full">
                <input type={resolvedType} className={inputStyles} {...props} />
